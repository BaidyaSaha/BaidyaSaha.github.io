...
function Contact() {
  return (
    <>
      ...
      <div class="contact_bg container-fluid ">
        <div class="login-box container-sm  mx-auto">
          ...
          <form
            ...
            action="mailto:ssengole@student.concordia.ab.ca"
            method="post"
            enctype="text/plain"
          >
            <div class="user-box">
      ...
      <Card.Footer className="text-center bg-white rounded-0 border-top pt-3 pb-2 fs-5 text-secondary fw-normal others_card">
        Copyright &copy; 2025
      </Card.Footer>
    </>
  );
